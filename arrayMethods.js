...
const results = mixedNumbers.filter(num => num %2 ===0);
// const checkEvenNumbers = (mixedNumbers) => {
...
// CODE HERE
 const totalPopulation   = populations.reduce((accumulator, current)=> accumulator+current)
...
// CODE HERE
// const orderTotals2 = orders.map(orderAmount => orderAmount.price(orderAmount.price + orderAmount.tax))
